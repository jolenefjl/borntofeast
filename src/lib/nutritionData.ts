...
export const nutritionData: Record<string, NutritionValues> = {
  bacon: {calories: 541, protein: 37, carbs: 1.4, fat: 42, gramsPerUnit: 12},
  ...
  egg: {calories: 143, protein: 12.6, carbs: 0.7, fat: 9.5, gramsPerUnit: 50},
  eggs: {calories: 143, protein: 12.6, carbs: 0.7, fat: 9.5, gramsPerUnit: 50},
  garlic: {calories: 149, protein: 6.4, carbs: 33, fat: 0.5, gramsPerUnit: 5},
  "garlic-chopped": {calories: 149, protein: 6.4, carbs: 33, fat: 0.5, gramsPerUnit: 5},
  ...
  "neutral-cooking-oil": {calories: 884, protein: 0, carbs: 0, fat: 100},
  onion: {calories: 40, protein: 1.1, carbs: 9.3, fat: 0.1},
  rice: {calories: 130, protein: 2.7, carbs: 28, fat: 0.3},
  "cooked-jasmine-rice": {calories: 130, protein: 2.7, carbs: 28, fat: 0.3},
  "cooked-short-grain-rice": {calories: 130, protein: 2.7, carbs: 28, fat: 0.3},
  "sesame-oil": {calories: 884, protein: 0, carbs: 0, fat: 100},
  shrimp: {calories: 99, protein: 24, carbs: 0.2, fat: 0.3, gramsPerUnit: 20},
  "raw-shelled-prawns-scampi": {
    calories: 99,
    protein: 24,
    carbs: 0.2,
    fat: 0.3,
