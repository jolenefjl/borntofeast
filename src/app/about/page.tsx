    ...
    <main className="min-h-screen bg-[#fff3c7] text-[#240B36]">
      <section className="relative isolate overflow-hidden border-b-4 border-[#240B36] bg-[#e55224] px-5 pb-20 pt-6 sm:px-8 sm:pb-28 lg:pb-32 lg:pt-10">
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="mt-16 grid gap-8 lg:grid-cols-[0.92fr_1.08fr] lg:items-end">
            <div>
              <p className="text-sm font-medium lowercase">about born to feast</p>
      ...
      <section className="bg-[#ffd447] px-5 py-20 sm:px-8 sm:py-28 lg:py-32">
        <div className="mx-auto grid max-w-7xl gap-8 lg:grid-cols-[0.75fr_1.25fr] lg:items-start">
          ...
          <div className="space-y-6 text-xl font-normal leading-9">
            <p>
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="grid gap-5 lg:grid-cols-3">
            {values.map((value) => (
              <article
                key={value.title}
                className="border-4 border-[#240B36] bg-[#f77f1f] p-6 shadow-[8px_8px_0_#240B36] transition duration-200 hover:-translate-y-2 hover:shadow-[12px_12px_0_#240B36]"
              >
                <h3 className="font-serif text-4xl font-black lowercase leading-none">
                  {value.title}
                </h3>
                <p className="mt-4 text-lg font-normal leading-8">
                  {value.copy}
                </p>
              </article>
            ))}
      ...
      <section className="bg-[#240B36] px-5 py-20 text-[#fff3c7] sm:px-8 sm:py-28 lg:py-32">
        <div className="mx-auto grid max-w-7xl gap-8 lg:grid-cols-[1fr_0.9fr] lg:items-center">
          <div>
            ...
            <p className="mt-6 text-xl font-normal leading-9">
